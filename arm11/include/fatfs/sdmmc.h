...
// TODO
// change this to 0x10007000 or 0x10100000 (the latter seems more promising)
// change start.S to clear bit 9
//
// why does it say bit8 should be cleared for arm9, when we write 0x340 which sets bit 8
// what does openagb actually do?
//
// openagb zeroes bits 8 and 9, but who knows if this actually works
#define SDMMC_BASE				0x10100000
